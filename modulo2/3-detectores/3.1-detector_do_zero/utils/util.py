...
def obtemDataSetDetector(arquivo, tamanho=0.30):
...
def obtemDataSetClassificador(dados, tamanho=0.30):
...
def obtemDataFrame(arquivo, classificador=True):
    return pd.read_csv(arquivo, delimiter=";" if not classificador else " ")
